...
//            return -1;
//        }else if(leftDist ==-1) {
//            return rightDist+1; //means right me valid value
//        }else {
//            return leftDist+1; //menas left me valid value
//        }
    }
    public static int minDist(Node root, int n1, int n2) {
        Node lca = lca(root, n1, n2); //gets lca

        int d1 = lcaDist(lca, n1); //find dist
