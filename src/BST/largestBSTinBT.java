...
public class largestBSTinBT {
    ...
    public static Info largestBST(Node root) {
        ...
        Info leftInfo = largestBST(root.left); //gets left info
        Info rightInfo = largestBST(root.right); //gets right info
        ...
        return new Info(false, sz, max, min); //Root node is not valid BST
    }
